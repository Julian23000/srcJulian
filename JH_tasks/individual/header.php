...
<head>
    ...
    <link rel="stylesheet" href="../prject/stylesTry.css">
    <link rel="stylesheet" href="JulianStyles.css">
</head>
<body>
<div class="container-fluid">
    <div class="row" id="header"> <!--Header-->
        <div class="col-sm-4" id="logodiv"><!---Logo-->
            <a href="#"><img src="images/headerFooter/flag-of-italy.png" alt="Logo" class="center"
                                      id="header-logo"></a>
        </div>
        <div class="col-sm-8">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                            <div class="navbar-nav">
                                ...
                                <a class="nav-link" href="Main.php">Exercise 7</a>
                            </div>
                        </div>
                    </div>
                </nav>
